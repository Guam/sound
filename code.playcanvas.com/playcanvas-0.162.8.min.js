...
a[3]&&b[4]===a[4]&&b[5]===a[5]&&b[6]===a[6]&&b[7]===a[7]&&b[8]===a[8]&&b[9]===a[9]&&b[10]===a[10]&&b[11]===a[11]&&b[12]===a[12]&&b[13]===a[13]&&b[14]===a[14]&&b[15]===a[15]},isIdentity:function(){var a=this.data;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&0===a[4]&&1===a[5]&&0===a[6]&&0===a[7]&&0===a[8]&&0===a[9]&&1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]},mul2:function(a,b){var c,e,f,g,d,k,z,s,v,A,x,E,D,F,M,y,B,I,C,J;y=a.data;var H=b.data,K=this.data;c=y[0];e=y[1];f=y[2];
g=y[3];d=y[4];k=y[5];z=y[6];s=y[7];v=y[8];A=y[9];x=y[10];E=y[11];D=y[12];F=y[13];M=y[14];y=y[15];B=H[0];I=H[1];C=H[2];J=H[3];K[0]=c*B+d*I+v*C+D*J;K[1]=e*B+k*I+A*C+F*J;K[2]=f*B+z*I+x*C+M*J;K[3]=g*B+s*I+E*C+y*J;B=H[4];I=H[5];C=H[6];J=H[7];K[4]=c*B+d*I+v*C+D*J;K[5]=e*B+k*I+A*C+F*J;K[6]=f*B+z*I+x*C+M*J;K[7]=g*B+s*I+E*C+y*J;B=H[8];I=H[9];C=H[10];J=H[11];K[8]=c*B+d*I+v*C+D*J;K[9]=e*B+k*I+A*C+F*J;K[10]=f*B+z*I+x*C+M*J;K[11]=g*B+s*I+E*C+y*J;B=H[12];I=H[13];C=H[14];J=H[15];K[12]=c*B+d*I+v*C+D*J;K[13]=e*B+
k*I+A*C+F*J;K[14]=f*B+z*I+x*C+M*J;K[15]=g*B+s*I+E*C+y*J;return this},mul:function(a){return this.mul2(this,a)},transformPoint:function(a,b){var c=this.data,e=a.data,b=void 0===b?new pc.Vec3:b;return b.set(e[0]*c[0]+e[1]*c[4]+e[2]*c[8]+c[12],e[0]*c[1]+e[1]*c[5]+e[2]*c[9]+c[13],e[0]*c[2]+e[1]*c[6]+e[2]*c[10]+c[14])},transformVector:function(a,b){var c=this.data,e=a.data,b=void 0===b?new pc.Vec3:b;return b.set(e[0]*c[0]+e[1]*c[4]+e[2]*c[8],e[0]*c[1]+e[1]*c[5]+e[2]*c[9],e[0]*c[2]+e[1]*c[6]+e[2]*c[10])},
...
0;e[15]=1;return this},invert:function(){var a,b,c,e,f,g,d,k,z,s,v,A,x,E,D,F,M,y,B,I,C,J,H,K,P,Q,N,L,R,O;O=this.data;a=O[0];b=O[1];c=O[2];e=O[3];f=O[4];g=O[5];d=O[6];k=O[7];z=O[8];s=O[9];v=O[10];A=O[11];x=O[12];E=O[13];D=O[14];F=O[15];M=a*g-b*f;y=a*d-c*f;B=a*k-e*f;I=b*d-c*g;C=b*k-e*g;J=c*k-e*d;H=z*E-s*x;K=z*D-v*x;P=z*F-A*x;Q=s*D-v*E;N=s*F-A*E;L=v*F-A*D;R=1/(M*L-y*N+B*Q+I*P-C*K+J*H);O[0]=(g*L-d*N+k*Q)*R;O[1]=(-b*L+c*N-e*Q)*R;O[2]=(E*J-D*C+F*I)*R;O[3]=(-s*J+v*C-A*I)*R;O[4]=(-f*L+d*P-k*K)*R;O[5]=(a*
L-c*P+e*K)*R;O[6]=(-x*J+D*B-F*y)*R;O[7]=(z*J-v*B+A*y)*R;O[8]=(f*N-g*P+k*H)*R;O[9]=(-a*N+b*P-e*H)*R;O[10]=(x*C-E*B+F*M)*R;O[11]=(-z*C+s*B-A*M)*R;O[12]=(-f*Q+g*K-d*H)*R;O[13]=(a*Q-b*K+c*H)*R;O[14]=(-x*I+E*y-D*M)*R;O[15]=(z*I-s*y+v*M)*R;return this},setIdentity:function(){var a=this.data;a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return this},setTRS:function(a,b,c){var e,f,g,d,k,z,s,v,A,x,E,D,F;e=a.x;f=a.y;a=a.z;g=b.x;d=b.y;k=
b.z;z=b.w;b=c.x;s=c.y;c=c.z;v=g+g;A=d+d;x=k+k;E=g*v;D=g*A;g*=x;F=d*A;d*=x;k*=x;v*=z;A*=z;z*=x;x=this.data;x[0]=(1-(F+k))*b;x[1]=(D+z)*b;x[2]=(g-A)*b;x[3]=0;x[4]=(D-z)*s;x[5]=(1-(E+k))*s;x[6]=(d+v)*s;x[7]=0;x[8]=(g+A)*c;x[9]=(d-v)*c;x[10]=(1-(E+F))*c;x[11]=0;x[12]=e;x[13]=f;x[14]=a;x[15]=1;return this},transpose:function(){var a,b=this.data;a=b[1];b[1]=b[4];b[4]=a;a=b[2];b[2]=b[8];b[8]=a;a=b[3];b[3]=b[12];b[12]=a;a=b[6];b[6]=b[9];b[9]=a;a=b[7];b[7]=b[13];b[13]=a;a=b[11];b[11]=b[14];b[14]=a;return this},
...
2==a.normal&&(b+="\nvarying mat3 ParticleMat;\n"),b+="\nuniform vec3 lightCube[6];\n");0==a.normal&&"none"==a.fog&&(a.srgb=!1);b+=a.srgb?c.gamma2_2PS:c.gamma1_0PS;b=b+"struct psInternalData {float dummy;};\n"+c.defaultTonemapping;b="linear"===a.fog?b+c.fogLinearPS:"exp"===a.fog?b+c.fogExpPS:"exp2"===a.fog?b+c.fogExp2PS:b+c.fogNonePS;b+=c.particlePS;0<a.soft&&(b+=c.particle_softPS);1==a.normal&&(b+="\nvec3 normal = Normal;\n");2==a.normal&&(b+=c.particle_normalMapPS);0<a.normal&&(b+=a.halflambert?
c.particle_halflambertPS:c.particle_lambertPS);0<a.normal&&(b+=c.particle_lightingPS);a.blend==pc.scene.BLEND_NORMAL?b+=c.particle_blendNormalPS:a.blend==pc.scene.BLEND_ADDITIVE?b+=c.particle_blendAddPS:a.blend==pc.scene.BLEND_MULTIPLICATIVE&&(b+=c.particle_blendMultiplyPS);b+=c.particle_endPS;return{attributes:pc.gfx.shaderChunks.collectAttribs(e),vshader:e,fshader:b}}};pc.gfx.programlib.phong={generateKey:function(d,a){var b=[],c="phong";for(prop in a)if("lights"===prop)for(var e=0;e<a.lights.length;e++)b.push(a.lights[e].getType()+"_"+(a.lights[e].getCastShadows()?1:0)+"_"+a.lights[e].getFalloffMode());else a[prop]&&b.push(prop);b.sort();for(prop in b)c+="_"+b[prop]+":"+a[b[prop]];return c},_setMapTransform:function(d,a,b){d[0]+="uniform vec4 texture_"+a+"MapTransform;\n";d[3][b]||(d[1]+="varying vec2 vUv0_"+b+";\n",d[2]+="   vUv0_"+b+"   = uv0 * texture_"+a+"MapTransform.xy + texture_"+
...
r=new pc.Mat3,m=new pc.Mat4,w=new pc.Mat4,u=[];for(i=0;8>i;i++)u.push(new pc.Vec3);pc.extend(b.prototype,{setCamera:function(a){var b=a.getProjectionMatrix();this.projId.setValue(b.data);var c=a.getWorldTransform();this.viewInvId.setValue(c.data);n.copy(c).invert();this.viewId.setValue(n.data);r.data[0]=n.data[0];r.data[1]=n.data[1];r.data[2]=n.data[2];r.data[3]=n.data[4];r.data[4]=n.data[5];r.data[5]=n.data[6];r.data[6]=n.data[8];r.data[7]=n.data[9];r.data[8]=n.data[10];this.viewId3.setValue(r.data);
...
g._shadowResolution,g._shadowBias]))},render:function(b,c){var e=this.device,n=e.scope;b._activeCamera=c;b.updateShaders&&(b._updateShaders(e),b.updateShaders=!1);var m=b._lights,r=b.drawCalls,E=b.shadowCasters,D,F,M,y,B,I,C,J=null;D=0;for(numDrawCalls=b.drawCalls.length;D<numDrawCalls;D++)y=b.drawCalls[D],y.skinInstance&&y.skinInstance.updateMatrixPalette();b._globalLights.length=0;b._localLights[0].length=0;for(D=b._localLights[1].length=0;D<m.length;D++){var H=m[D];H.getEnabled()&&(H.getType()===
pc.scene.LIGHTTYPE_DIRECTIONAL?b._globalLights.push(H):b._localLights[H.getType()===pc.scene.LIGHTTYPE_POINT?0:1].push(H))}H=c.getPosition();D=0;for(numDrawCalls=r.length;D<numDrawCalls;D++)if(y=r[D],!y.command&&(B=y,B.layer===pc.scene.LAYER_WORLD))if(B.material.blendType===pc.scene.BLEND_NORMAL||B.material.blendType===pc.scene.BLEND_PREMULTIPLIED){B.syncAabb();var K=B.aabb.center,P=K.x-H.x;y=K.y-H.y;K=K.z-H.z;B.distSqr=P*P+y*y+K*K}else void 0!==B.distSqr&&delete B.distSqr;r.sort(d);if(c._depthTarget){H=
c.getRenderTarget();c.setRenderTarget(c._depthTarget);this.setCamera(c);P=e.getBlending();e.setBlending(!1);D=0;for(numDrawCalls=r.length;D<numDrawCalls;D++){y=r[D];if(!y.command&&y.drawToDepth){B=y;I=B.mesh;this.modelMatrixId.setValue(B.node.worldTransform.data);if(B.skinInstance){if(e.supportsBoneTextures){this.boneTextureId.setValue(B.skinInstance.boneTexture);var Q=B.skinInstance.boneTexture.width,N=B.skinInstance.boneTexture.height;this.boneTextureSizeId.setValue([Q,N])}else this.poseMatrixId.setValue(B.skinInstance.matrixPalette);
e.setShader(this._depthShaderSkin)}else e.setShader(this._depthShaderStatic);B=B.renderStyle;e.setVertexBuffer(I.vertexBuffer,0);e.setIndexBuffer(I.indexBuffer[B]);e.draw(I.primitive[B])}c.setRenderTarget(H)}e.setBlending(P)}for(D=0;D<m.length;D++)if(H=m[D],P=H.getType(),H.getCastShadows()&&H.getEnabled()){y=e;K=H;B=K._shadowCamera;F=void 0;null===B?(B=K,F=pc.gfx.CLEARFLAG_DEPTH,y.extDepthTexture||(F|=pc.gfx.CLEARFLAG_COLOR),I=new pc.scene.CameraNode,I.setClearOptions({color:[1,1,1,1],depth:1,flags:F}),
B=B._shadowCamera=I,a(y,K)):(F=B.getRenderTarget(),(F.width!==K._shadowResolution||F.height!==K._shadowResolution)&&a(y,K));y=B;var K=1,L;if(P===pc.scene.LIGHTTYPE_DIRECTIONAL){B=c;F=this.centroid;F.set(0,0,0.5*-(b.shadowDistance+B._nearClip));B.getWorldTransform().transformPoint(F,F);y.setPosition(this.centroid);y.setRotation(H.getRotation());y.rotateLocal(-90,0,0);C=b;B=c;F=u;M=B;I=M.getNearClip();C=C.shadowDistance;Q=M.getFov()*Math.PI/180;N=M.getAspectRatio();M=M.getProjection();var R=L=void 0,
R=M===pc.scene.Projection.PERSPECTIVE?Math.tan(Q/2)*I:B._orthoHeight;L=R*N;F[0].x=L;F[0].y=-R;F[0].z=-I;F[1].x=L;F[1].y=R;F[1].z=-I;F[2].x=-L;F[2].y=R;F[2].z=-I;F[3].x=-L;F[3].y=-R;F[3].z=-I;M===pc.scene.Projection.PERSPECTIVE&&(R=Math.tan(Q/2)*C,L=R*N);F[4].x=L;F[4].y=-R;F[4].z=-C;F[5].x=L;F[5].y=R;F[5].z=-C;F[6].x=-L;F[6].y=R;F[6].z=-C;F[7].x=-L;F[7].y=-R;F[7].z=-C;k.copy(y.getWorldTransform());B=k.invert();w.mul2(B,c.worldTransform);for(F=0;8>F;F++)w.transformPoint(u[F],u[F]);B=I=C=1E6;Q=N=M=-1E6;
for(F=0;8>F;F++)L=u[F],L.x<B&&(B=L.x),L.x>Q&&(Q=L.x),L.y<I&&(I=L.y),L.y>N&&(N=L.y),L.z<C&&(C=L.z),L.z>M&&(M=L.z);y.translateLocal(0.5*-(Q+B),0.5*(N+I),M+0.25*(M-C));k.copy(y.getWorldTransform());y.setProjection(pc.scene.Projection.ORTHOGRAPHIC);y.setNearClip(0);y.setFarClip(1.5*(M-C));y.setAspectRatio((Q-B)/(N-I));y.setOrthoHeight(0.5*(N-I))}else P===pc.scene.LIGHTTYPE_SPOT?(y.setProjection(pc.scene.Projection.PERSPECTIVE),y.setNearClip(H.getAttenuationEnd()/1E3),y.setFarClip(H.getAttenuationEnd()),
y.setAspectRatio(1),y.setFov(2*H.getOuterConeAngle()),k.mul2(H.worldTransform,f)):P===pc.scene.LIGHTTYPE_POINT&&(y.setProjection(pc.scene.Projection.PERSPECTIVE),y.setNearClip(H.getAttenuationEnd()/1E3),y.setFarClip(H.getAttenuationEnd()),y.setAspectRatio(1),y.setFov(90),K=6,this.viewPosId.setValue(y.getPosition().data),this.lightRadiusId.setValue(H.getAttenuationEnd()));P!=pc.scene.LIGHTTYPE_POINT&&(h.copy(k).invert(),l.mul2(y.getProjectionMatrix(),h),H._shadowMatrix.mul2(g,l),y.worldTransform.copy(k));
for(L=0;L<K;L++){P===pc.scene.LIGHTTYPE_POINT&&(0===L?y.setEulerAngles(0,90,180):1===L?y.setEulerAngles(0,-90,180):2===L?y.setEulerAngles(90,0,0):3===L?y.setEulerAngles(-90,0,0):4===L?y.setEulerAngles(0,180,180):5===L&&y.setEulerAngles(0,0,180),y.setPosition(H.getPosition()),y.setRenderTarget(H._shadowCubeMap[L]));this.setCamera(y);e.setBlending(!1);e.setColorWrite(!0,!0,!0,!0);e.setDepthWrite(!0);e.setDepthTest(!0);e.extDepthTexture&&e.setColorWrite(!1,!1,!1,!1);F=0;for(M=E.length;F<M;F++)B=E[F],
I=B.mesh,C=B.material,e.setCullMode(C.cull),this.modelMatrixId.setValue(B.node.worldTransform.data),C.opacityMap&&n.resolve("texture_opacityMap").setValue(C.opacityMap),B.skinInstance?(e.supportsBoneTextures?(this.boneTextureId.setValue(B.skinInstance.boneTexture),Q=B.skinInstance.boneTexture.width,N=B.skinInstance.boneTexture.height,this.boneTextureSizeId.setValue([Q,N])):this.poseMatrixId.setValue(B.skinInstance.matrixPalette),P===pc.scene.LIGHTTYPE_POINT?e.setShader(C.opacityMap?this._depthProgSkinOpPoint:
this._depthProgSkinPoint):e.setShader(C.opacityMap?this._depthProgSkinOp:this._depthProgSkin)):P===pc.scene.LIGHTTYPE_POINT?e.setShader(C.opacityMap?this._depthProgStaticOpPoint:this._depthProgStaticPoint):e.setShader(C.opacityMap?this._depthProgStaticOp:this._depthProgStatic),B=B.renderStyle,e.setVertexBuffer(I.vertexBuffer,0),e.setIndexBuffer(I.indexBuffer[B]),e.draw(I.primitive[B])}}this.setCamera(c);this.dispatchGlobalLights(b);this.dispatchLocalLights(b);if(b.fog!==pc.scene.FOG_NONE){this.fogColor[0]=
b.fogColor.r;this.fogColor[1]=b.fogColor.g;this.fogColor[2]=b.fogColor.b;if(b.gammaCorrection)for(D=0;3>D;D++)this.fogColor[D]=Math.pow(this.fogColor[D],2.2);this.fogColorId.setValue(this.fogColor);b.fog===pc.scene.FOG_LINEAR?(this.fogStartId.setValue(b.fogStart),this.fogEndId.setValue(b.fogEnd)):this.fogDensityId.setValue(b.fogDensity)}D=0;for(numDrawCalls=r.length;D<numDrawCalls;D++)if(y=r[D],y.command)y.command();else{B=y;I=B.mesh;C=B.material;n=B.node.worldTransform;m=B.normalMatrix;n.invertTo3x3(m);
m.transpose();this.modelMatrixId.setValue(n.data);this.normalMatrixId.setValue(m.data);B.skinInstance&&(e.supportsBoneTextures?(this.boneTextureId.setValue(B.skinInstance.boneTexture),Q=B.skinInstance.boneTexture.width,N=B.skinInstance.boneTexture.height,this.boneTextureSizeId.setValue([Q,N])):this.poseMatrixId.setValue(B.skinInstance.matrixPalette));this.shadowEnableId.setValue(B.receiveShadow);if(C!==J){C.shader||C.updateShader(e,b);e.setShader(C.shader);var J=C.parameters,O;for(O in J)n=J[O],n.scopeId||
(n.scopeId=e.scope.resolve(O)),n.scopeId.setValue(n.data);this.alphaTestId.setValue(C.alphaTest);e.setBlending(C.blend);e.setBlendFunction(C.blendSrc,C.blendDst);e.setBlendEquation(C.blendEquation);e.setColorWrite(C.redWrite,C.greenWrite,C.blueWrite,C.alphaWrite);e.setCullMode(C.cull);e.setDepthWrite(C.depthWrite);e.setDepthTest(C.depthTest)}e.setVertexBuffer(I.vertexBuffer,0);B=B.renderStyle;e.setIndexBuffer(I.indexBuffer[B]);e.draw(I.primitive[B]);J=C}}});return{ForwardRenderer:b}}());pc.extend(pc.scene,function(){var d=function(a){this.name=a||"Untitled";this._labels={};this.localPosition=new pc.Vec3(0,0,0);this.localRotation=new pc.Quat(0,0,0,1);this.localScale=new pc.Vec3(1,1,1);this.localEulerAngles=new pc.Vec3(0,0,0);this.position=new pc.Vec3(0,0,0);this.rotation=new pc.Quat(0,0,0,1);this.eulerAngles=new pc.Vec3(0,0,0);this.localTransform=new pc.Mat4;this.dirtyLocal=!1;this.worldTransform=new pc.Mat4;this.dirtyWorld=!1;this._right=new pc.Vec3;this._up=new pc.Vec3;this._forward=
...
for(f=0;f<w.length;f++){var u=n.indexOf(w[f]);-1!==u&&n.splice(u,1)}if(0===w.length)throw Error("partitionSkin: There should be at least one mesh that references a skin");var G=w[0].vertices;for(f=1;f<w.length;f++)if(w[f].vertices!==G)throw Error("partitionSkin: All meshes that share a skin should also share the same vertex buffer");var z=[],s=function(a){var b=new d;b.index=a;return b};k=[];var v=[],A=0;for(f=0;f<w.length;f++){for(var x=w[f],E=x.indices,D=x.base;D<x.base+x.count;){u=E[D++];k[0]=
s(u);v[0]=u;u=E[D++];k[1]=s(u);v[1]=u;u=E[D++];k[2]=s(u);v[2]=u;for(var F=!1,M=A;M<z.length;M++)if(u=z[M],u.addPrimitive(k,v,G,e)){F=!0;break}F||(u=new a,u.originalMesh=x,u.addPrimitive(k,v,G,e),z.push(u))}A=z.length}x=[];w=[];for(f=0;f<z.length;f++)if(u=z[f],u.vertices.length&&u.indices.length){s=x.length;k=u.vertices.length;v=w.length;A=u.indices.length;u.partition=f;u.vertexStart=s;u.vertexCount=k;u.indexStart=v;u.indexCount=A;E=0;for(D=s;E<k;)x[D++]=u.vertices[E++];E=0;for(D=v;E<A;)w[D++]=u.indices[E++]+
s}s=[];for(f=0;f<z.length;f++){u=z[f];v=[];A=[];for(k=0;k<u.boneIndices.length;k++)v.push(m.inverseBindMatrices[u.boneIndices[k]]),A.push(m.boneNames[u.boneIndices[k]]);u={inverseBindMatrices:v,boneNames:A};s.push(u);l.push(u)}var y,m={};for(y in G)m[y]={components:G[y].components,data:[],type:G[y].type};for(y in G)if("blendIndices"===y){u=m[y].data;for(f=0;f<x.length;f++)k=x[f].boneIndices,u.push(k[0],k[1],k[2],k[3])}else{f=G[y];data=f.data;components=f.components;for(f=0;f<x.length;f++){u=x[f].index;
for(k=0;k<components;k++)m[y].data.push(data[u*components+k])}}h[h.indexOf(G)]=m;for(f=0;f<z.length;f++){u=z[f];x={aabb:{min:[0,0,0],max:[0,0,0]},vertices:m,skin:s[f],indices:w.splice(0,u.indexCount),type:"triangles",base:0,count:u.indexCount};n.push(x);for(k=r.length-1;0<=k;k--)r[k].mesh===u.originalMesh&&(r.push({mesh:x,node:r[k].node}),c&&c.push({material:c[k].material,path:c[k].path}))}for(f=0;f<z.length;f++){u=z[f];for(k=r.length-1;0<=k;k--)r[k].mesh===u.originalMesh&&(r.splice(k,1),c&&c.splice(k,
...
new pc.Vec3(0,0,1);this.camera=this.particleNoize=this.particleDistance=this.vbOld=this.vbToSort=this.internalTex3=this.internalTex2=this.internalTex1=this.internalTex0=null;this.swapTex=!1;this.useMesh=!0;this.useCpu=!1;this.shaderParticleUpdateOnStop=this.shaderParticleUpdateNoRespawn=this.shaderParticleUpdateRespawn=null;this.numParticleIndices=this.numParticleVerts=0;this.meshInstance=this.material=null;this.seed=0;this.rebuild()};L.prototype={onChangeCamera:function(){if(0<this.depthSoftening&&
this.camera&&!this.camera._depthTarget){var a=this.camera,b;b=this.graphicsDevice;var c=this.camera._rect,c=new pc.gfx.Texture(b,{format:pc.gfx.PIXELFORMAT_R8_G8_B8_A8,width:Math.floor(c.width*b.width),height:Math.floor(c.height*b.height)});c.minFilter=pc.gfx.FILTER_NEAREST;c.magFilter=pc.gfx.FILTER_NEAREST;c.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;c.addressV=pc.gfx.ADDRESS_CLAMP_TO_EDGE;b=new pc.gfx.RenderTarget(b,c,{depth:!0});a._depthTarget=b;this._depthTarget=this.camera._depthTarget}this.regenShader();
this.resetMaterial()},rebuild:function(){var a,b=this.graphicsDevice;this.useCpu=(this.useCpu=this.mode===pc.scene.PARTICLEMODE_CPU)||this.sort>pc.scene.PARTICLESORT_NONE||!(b.extTextureFloat&&1<=b.maxVertexTextures&&b.extTextureFloatRenderable)||100>b.fragmentUniformsCount;this.vertexBuffer=void 0;this.useMesh=!1;this.mesh&&(65535<this.numParticles*this.mesh.vertexBuffer.numVertices?console.warn("WARNING: particle system can't render mesh particles because numParticles * numVertices is more than 65k. Reverting to quad particles."):
this.useMesh=!0);this.numParticlesPot=pc.math.nextPowerOfTwo(this.numParticles);this.rebuildGraphs();this.vbToSort=Array(this.numParticles);this.particleDistance=new Float32Array(this.numParticles);this.particleNoize=new Float32Array(this.numParticles);for(a=0;a<this.numParticles;a++)this.particleNoize[a]=Math.random();this.particleTex=new Float32Array(8*this.numParticlesPot);var c=null===this.node?pc.Vec3.ZERO:this.node.getPosition();null===this.node?J.setTRS(pc.Vec3.ZERO,pc.Quat.IDENTITY,this.spawnBounds):
J.setTRS(pc.Vec3.ZERO,this.node.getRotation(),P.copy(this.spawnBounds).mul(this.node.getLocalScale()));for(a=0;a<this.numParticles;a++)this.calcSpawnPosition(c,a);this.particleTexStart=new Float32Array(8*this.numParticlesPot);for(a=0;a<this.particleTexStart.length;a++)this.particleTexStart[a]=this.particleTex[a];this.useCpu||(this.particleTexIN=k(b,this.numParticlesPot,2,this.particleTex),this.particleTexOUT=k(b,this.numParticlesPot,2,this.particleTex),this.particleTexStart=k(b,this.numParticlesPot,
2,this.particleTexStart),this.rtParticleTexIN=new pc.gfx.RenderTarget(b,this.particleTexIN,{depth:!1}),this.rtParticleTexOUT=new pc.gfx.RenderTarget(b,this.particleTexOUT,{depth:!1}),this.swapTex=!1);a=pc.gfx.shaderChunks;var c=a.particleUpdaterStartPS+a.particleUpdaterEndPS,e=a.particleUpdaterStartPS+a.particleUpdaterOnStopPS+a.particleUpdaterEndPS;this.shaderParticleUpdateRespawn=a.createShaderFromCode(b,a.fullscreenQuadVS,a.particleUpdaterStartPS+a.particleUpdaterRespawnPS+a.particleUpdaterEndPS,
"fsQuad0");this.shaderParticleUpdateNoRespawn=a.createShaderFromCode(b,a.fullscreenQuadVS,c,"fsQuad1");this.shaderParticleUpdateOnStop=a.createShaderFromCode(b,a.fullscreenQuadVS,e,"fsQuad2");this.numParticleVerts=this.useMesh?this.mesh.vertexBuffer.numVertices:4;this.numParticleIndices=this.useMesh?this.mesh.indexBuffer[0].numIndices:6;this._allocate(this.numParticles);b=new pc.scene.Mesh;b.vertexBuffer=this.vertexBuffer;b.indexBuffer[0]=this.indexBuffer;b.primitive[0].type=pc.gfx.PRIMITIVE_TRIANGLES;
b.primitive[0].base=0;b.primitive[0].count=this.numParticles*this.numParticleIndices;b.primitive[0].indexed=!0;this.material=new pc.scene.Material;this.material.cullMode=pc.gfx.CULLFACE_NONE;this.material.blend=!0;this.material.blendType=this.blendType;this.material.depthWrite=this.depthWrite;this.material.emitter=this;this.regenShader();this.resetMaterial();this.meshInstance=new pc.scene.MeshInstance(this.node,b,this.material);this.meshInstance.updateKey();this.meshInstance.drawToDepth=!1;this._initializeTextures();
this.addTime(0);this.preWarm&&this.prewarm(this.lifetime);this.resetTime()},calcSpawnPosition:function(a,b){H.data[0]=this.particleNoize[b]-0.5;H.data[1]=10*this.particleNoize[b]%1-0.5;H.data[2]=100*this.particleNoize[b]%1-0.5;K.copy(a).add(J.transformPoint(H));this.particleTex[4*b]=K.data[0];this.particleTex[4*b+1]=K.data[1];this.particleTex[4*b+2]=K.data[2];this.particleTex[4*b+3]=pc.math.lerp(this.startAngle*pc.math.DEG_TO_RAD,this.startAngle2*pc.math.DEG_TO_RAD,this.particleNoize[b]);var c=-pc.math.lerp(this.rate,
this.rate2,this.particleNoize[b])*b;this.particleTex[4*b+3+4*this.numParticlesPot]=c},rebuildGraphs:function(){var a=this.precision,b=this.graphicsDevice,d;this.qLocalVelocity=this.localVelocityGraph.quantize(a);this.qVelocity=this.velocityGraph.quantize(a);this.qColor=this.colorGraph.quantize(a);this.qRotSpeed=this.rotationSpeedGraph.quantize(a);this.qScale=this.scaleGraph.quantize(a);this.qAlpha=this.alphaGraph.quantize(a);this.qLocalVelocity2=this.localVelocityGraph2.quantize(a);this.qVelocity2=
this.velocityGraph2.quantize(a);this.qColor2=this.colorGraph2.quantize(a);this.qRotSpeed2=this.rotationSpeedGraph2.quantize(a);this.qScale2=this.scaleGraph2.quantize(a);this.qAlpha2=this.alphaGraph2.quantize(a);for(d=0;d<a;d++)this.qRotSpeed[d]*=pc.math.DEG_TO_RAD,this.qRotSpeed2[d]*=pc.math.DEG_TO_RAD;this.localVelocityUMax=new pc.Vec3(0,0,0);this.velocityUMax=new pc.Vec3(0,0,0);this.colorUMax=new pc.Vec3(0,0,0);this.rotSpeedUMax=[0];this.scaleUMax=[0];this.alphaUMax=[0];this.qLocalVelocityDiv=e(this.qLocalVelocity,
this.qLocalVelocity2,this.localVelocityUMax.data);this.qVelocityDiv=e(this.qVelocity,this.qVelocity2,this.velocityUMax.data);this.qColorDiv=e(this.qColor,this.qColor2,this.colorUMax.data);this.qRotSpeedDiv=e(this.qRotSpeed,this.qRotSpeed2,this.rotSpeedUMax);this.qScaleDiv=e(this.qScale,this.qScale2,this.scaleUMax);this.qAlphaDiv=e(this.qAlpha,this.qAlpha2,this.alphaUMax);if(!this.useCpu){this.internalTex0=k(b,a,1,c(this.qLocalVelocity,this.qLocalVelocityDiv));this.internalTex1=k(b,a,1,c(this.qVelocity,
this.qVelocityDiv));d=this.qRotSpeed;for(var g=this.qScale,f=this.qScaleDiv,h=this.qRotSpeedDiv,l=this.qAlphaDiv,n=Array(4*d.length),m=0;m<d.length;m++)n[4*m]=d[m],n[4*m+1]=g[m],n[4*m+2]=0,n[4*m+3]=(255*f[m]<<16|255*h[m]<<8|255*l[m])/16777216;this.internalTex2=k(b,a,1,n)}d=this.qColor;g=this.qAlpha;f=Array(4*g.length);for(h=0;h<g.length;h++)f[4*h]=d[3*h],f[4*h+1]=d[3*h+1],f[4*h+2]=d[3*h+2],f[4*h+3]=g[h];this.internalTex3=k(b,a,1,f,pc.gfx.PIXELFORMAT_R8_G8_B8_A8,1)},_initializeTextures:function(){this.colorMap&&
(this.material.setParameter("colorMap",this.colorMap),this.lighting&&this.normalMap&&this.material.setParameter("normalMap",this.normalMap))},_hasDepthTarget:function(){return this.camera?!!this.camera._depthTarget:!1},regenShader:function(){var a=this.graphicsDevice.getProgramLibrary(),b=null!=this.normalMap;this.normalOption=0;this.lighting&&(this.normalOption=b?2:1);this.material.updateShader=function(){var b=a.getProgram("particle",{useCpu:this.emitter.useCpu,normal:this.emitter.normalOption,
halflambert:this.emitter.halfLambert,stretch:this.emitter.stretch,alignToMotion:this.emitter.alignToMotion,soft:this.emitter.depthSoftening&&this.emitter._hasDepthTarget(),mesh:this.emitter.useMesh,srgb:this.emitter.scene?this.emitter.scene.gammaCorrection:!1,toneMap:this.emitter.scene?this.emitter.scene.toneMapping:0,fog:this.emitter.scene?this.emitter.scene.fog:"none",wrap:this.emitter.wrap&&this.emitter.wrapBounds,blend:this.blendType});this.setShader(b)};this.material.updateShader()},resetMaterial:function(){var a=
this.material,b=this.graphicsDevice;a.setParameter("stretch",this.stretch);a.setParameter("colorMult",this.intensity);this.useCpu||(a.setParameter("internalTex0",this.internalTex0),a.setParameter("internalTex1",this.internalTex1),a.setParameter("internalTex2",this.internalTex2));a.setParameter("internalTex3",this.internalTex3);a.setParameter("numParticles",this.numParticles);a.setParameter("numParticlesPot",this.numParticlesPot);a.setParameter("lifetime",this.lifetime);a.setParameter("rate",this.rate);
a.setParameter("rateDiv",this.rate2-this.rate);a.setParameter("seed",this.seed);a.setParameter("scaleDivMult",this.scaleUMax[0]);a.setParameter("alphaDivMult",this.alphaUMax[0]);a.setParameter("graphNumSamples",this.precision);a.setParameter("graphSampleSize",1/this.precision);a.setParameter("emitterScale",pc.Vec3.ONE.data);this.wrap&&this.wrapBounds&&a.setParameter("wrapBounds",this.wrapBounds.data);this.colorMap&&a.setParameter("colorMap",this.colorMap);this.lighting&&this.normalMap&&a.setParameter("normalMap",
this.normalMap);0<this.depthSoftening&&this._hasDepthTarget()&&(a.setParameter("uDepthMap",this.camera._depthTarget.colorBuffer),a.setParameter("screenSize",(new pc.Vec4(b.width,b.height,1/b.width,1/b.height)).data),a.setParameter("softening",1/(100*this.depthSoftening*this.depthSoftening)));0<this.stretch&&(a.cull=pc.gfx.CULLFACE_NONE)},_allocate:function(a){var b=a*this.numParticleVerts,c=a*this.numParticleIndices,e;if(void 0===this.vertexBuffer||this.vertexBuffer.getNumVertices()!==b){e=this.useCpu?
[{semantic:pc.gfx.SEMANTIC_ATTR0,components:4,type:pc.gfx.ELEMENTTYPE_FLOAT32},{semantic:pc.gfx.SEMANTIC_ATTR1,components:4,type:pc.gfx.ELEMENTTYPE_FLOAT32},{semantic:pc.gfx.SEMANTIC_ATTR2,components:4,type:pc.gfx.ELEMENTTYPE_FLOAT32},{semantic:pc.gfx.SEMANTIC_ATTR3,components:2,type:pc.gfx.ELEMENTTYPE_FLOAT32}]:[{semantic:pc.gfx.SEMANTIC_ATTR0,components:4,type:pc.gfx.ELEMENTTYPE_FLOAT32}];e=new pc.gfx.VertexFormat(this.graphicsDevice,e);this.vertexBuffer=new pc.gfx.VertexBuffer(this.graphicsDevice,
e,b,pc.gfx.BUFFER_DYNAMIC);this.indexBuffer=new pc.gfx.IndexBuffer(this.graphicsDevice,pc.gfx.INDEXFORMAT_UINT16,c);e=new Float32Array(this.vertexBuffer.lock());var d,g;this.useMesh&&(d=new Float32Array(this.mesh.vertexBuffer.lock()),g=d.length/this.mesh.vertexBuffer.numVertices);for(var h,c=0;c<b;c++){id=Math.floor(c/this.numParticleVerts);0===c%this.numParticleVerts&&(h=this.particleNoize[id]);if(this.useMesh){var l=c%this.numParticleVerts;e[4*c]=d[l*g];e[4*c+1]=d[l*g+1];e[4*c+2]=d[l*g+2]}else l=
c%4,e[4*c]=f[l][0],e[4*c+1]=f[l][1],e[4*c+2]=0;e[4*c+3]=id+h}this.useCpu&&(this.vbCPU=new Float32Array(e),this.vbOld=new Float32Array(this.vbCPU.length));this.vertexBuffer.unlock();this.useMesh&&this.mesh.vertexBuffer.unlock();b=0;indices=new Uint16Array(this.indexBuffer.lock());this.useMesh&&(d=new Uint16Array(this.mesh.indexBuffer[0].lock()));for(c=0;c<a;c++)if(this.useMesh)for(g=0;g<this.numParticleIndices;g++)indices[c*this.numParticleIndices+g]=d[g]+c*this.numParticleVerts;else g=4*c,indices[b++]=
g,indices[b++]=g+1,indices[b++]=g+2,indices[b++]=g,indices[b++]=g+2,indices[b++]=g+3;this.indexBuffer.unlock();this.useMesh&&this.mesh.indexBuffer[0].unlock()}},reset:function(){this.seed=Math.random();this.material.setParameter("seed",this.seed);if(this.useCpu)for(var a=0;a<this.particleTexStart.length;a++)this.particleTex[a]=this.particleTexStart[a];else this._initializeTextures();this.resetTime();a=this.loop;this.loop=!0;this.addTime(0);this.loop=a;this.preWarm&&this.prewarm(this.lifetime)},prewarm:function(a){for(var b=
Math.min(Math.floor(a/this.lifetime*this.precision),this.precision),a=a/b,c=0;c<b;c++)this.addTime(a)},resetTime:function(){var a=Math.max(this.rate,this.rate2)*this.numParticles+this.lifetime;this.endTime=Date.now()+1E3*a},addTime:function(b,c){var e,f,h=this.graphicsDevice;h.setBlending(!1);h.setColorWrite(!0,!0,!0,!0);h.setCullMode(pc.gfx.CULLFACE_NONE);h.setDepthTest(!1);h.setDepthWrite(!1);if(this.lighting){if(!this.scene){console.error("There is no scene defined for lighting particles");return}for(e=
0;6>e;e++)this.lightCube[3*e]=this.scene.ambientLight.r,this.lightCube[3*e+1]=this.scene.ambientLight.g,this.lightCube[3*e+2]=this.scene.ambientLight.b;var l=this.scene._globalLights;for(e=0;e<l.length;e++)for(f=0;6>f;f++){var k=Math.max(this.lightCubeDir[f].dot(l[e]._direction),0)*l[e]._intensity;this.lightCube[3*f]+=l[e]._color.r*k;this.lightCube[3*f+1]+=l[e]._color.g*k;this.lightCube[3*f+2]+=l[e]._color.b*k}this.constantLightCube.setValue(this.lightCube)}this.scene&&this.camera!=this.scene._activeCamera&&
(this.camera=this.scene._activeCamera,this.onChangeCamera());null===this.meshInstance.node?J.setTRS(pc.Vec3.ZERO,pc.Quat.IDENTITY,this.spawnBounds):J.setTRS(pc.Vec3.ZERO,this.meshInstance.node.getRotation(),P.copy(this.spawnBounds).mul(this.meshInstance.node.getLocalScale()));e=null===this.meshInstance.node?pc.Vec3.ONE.data:this.meshInstance.node.getLocalScale().data;this.material.setParameter("emitterScale",e);if(this.useCpu){l=new Float32Array(this.vertexBuffer.lock());if(this.meshInstance.node){e=
this.meshInstance.node.worldTransform;for(f=0;12>f;f++)D.data[f]=e.data[f];C=this.meshInstance.node.getLocalScale();I=Math.max(Math.max(C.x,C.y),C.z)}f=null===this.meshInstance.node?pc.Vec3.ZERO:this.meshInstance.node.getPosition();k=this.camera?this.camera.position:pc.Vec3.ZERO;if(this.camera){e=this.camera.getProjectionMatrix();var n=this.camera.getWorldTransform();y.copy(n);y.invert();B.mul2(e,y)}for(e=0;e<this.numParticles;e++){var n=Math.floor(this.vbCPU[4*e*this.numParticleVerts+3]),m=(this.particleNoize[n]+
this.seed)%1;s.x=m;s.y=10*m%1;s.z=100*m%1;var r=pc.math.lerp(this.rate,this.rate2,m),H=this.lifetime,N=this.particleTex[4*n+3+4*this.numParticlesPot]+b,L=d(N/H),K=0,Q=0,T=0<N&&N<H;if(T){u.data=a(this.qLocalVelocity,L,3,u.data);z.data=a(this.qLocalVelocity2,L,3,z.data);w.data=a(this.qVelocity,L,3,w.data);G.data=a(this.qVelocity2,L,3,G.data);var S=a(this.qRotSpeed,L),Q=a(this.qRotSpeed2,L),K=a(this.qScale,L),V=a(this.qScale2,L),W=a(this.qAlpha,L),X=a(this.qAlpha2,L);u.x=pc.math.lerp(u.x,z.x,s.x);u.y=
pc.math.lerp(u.y,z.y,s.y);u.z=pc.math.lerp(u.z,z.z,s.z);w.x=pc.math.lerp(w.x,G.x,s.x);w.y=pc.math.lerp(w.y,G.y,s.y);w.z=pc.math.lerp(w.z,G.z,s.z);S=pc.math.lerp(S,Q,s.y);K=pc.math.lerp(K,V,1E4*m%1)*I;Q=(X-W)*(1E3*m%1);this.meshInstance.node&&D.transformPoint(u,u);u.add(w.mul(C));E.copy(u);v.x=this.particleTex[4*n];v.y=this.particleTex[4*n+1];v.z=this.particleTex[4*n+2];A.copy(v).add(u.scale(b));x.copy(A);this.particleTex[4*n]=x.x;this.particleTex[4*n+1]=x.y;this.particleTex[4*n+2]=x.z;this.particleTex[4*
n+3]+=S*b;this.wrap&&this.wrapBounds&&(x.sub(f),x.x=x.x-this.wrapBounds.x*Math.floor(x.x/this.wrapBounds.x)-0.5*this.wrapBounds.x,x.y=x.y-this.wrapBounds.y*Math.floor(x.y/this.wrapBounds.y)-0.5*this.wrapBounds.y,x.z=x.z-this.wrapBounds.z*Math.floor(x.z/this.wrapBounds.z)-0.5*this.wrapBounds.z,x.add(f));0<this.sort&&(1===this.sort?(P.copy(x).sub(k),this.particleDistance[n]=-(P.x*P.x+P.y*P.y+P.z*P.z)):2===this.sort?this.particleDistance[n]=N:3===this.sort&&(this.particleDistance[n]=-N))}else this.calcSpawnPosition(f,
n);N>H&&this.loop&&(N=-r*n);0>=N&&c&&(N=H+1);this.particleTex[4*n+3+4*this.numParticlesPot]=N;for(m=0;m<this.numParticleVerts;m++)r=this.vbCPU[4*e*this.numParticleVerts+4*m],H=this.vbCPU[4*e*this.numParticleVerts+4*m+1],N=this.vbCPU[4*e*this.numParticleVerts+4*m+2],T||(r=H=N=0),S=14*e*this.numParticleVerts+14*m,l[S]=x.x,l[S+1]=x.y,l[S+2]=x.z,l[S+3]=L,l[S+4]=this.alignToMotion?0:this.particleTex[4*n+3],l[S+5]=K,l[S+6]=Q,l[S+7]=E.x,l[S+8]=r,l[S+9]=H,l[S+10]=N,l[S+11]=E.y,l[S+12]=E.z}if(this.sort>pc.scene.PARTICLESORT_NONE&&
this.camera){for(e=0;e<this.numParticles;e++)this.vbToSort[e]=[e,Math.floor(this.vbCPU[4*e*this.numParticleVerts+3])];for(e=0;e<this.vbCPU.length;e++)this.vbOld[e]=this.vbCPU[e];var U=this.particleDistance;this.vbToSort.sort(function(a,b){return U[a[1]]-U[b[1]]});for(e=0;e<this.numParticles;e++){l=this.vbToSort[e][0];for(k=0;k<this.numParticleVerts;k++)for(f=0;4>f;f++)this.vbCPU[4*e*this.numParticleVerts+4*k+f]=this.vbOld[4*l*this.numParticleVerts+4*k+f]}}this.vertexBuffer.unlock()}else this.frameRandom.x=
...
pc.scene.procedural.calculateTangents=function(d,a,b,c){var e=c.length/3,g=d.length/3,f,k,h,l,n,r,m,w,u,G,z,s,v,A,x=new pc.Vec3,E=new pc.Vec3,D=new pc.Vec3,F=new pc.Vec3,M=new pc.Vec3,y=new pc.Vec2,B=new pc.Vec2,I=new pc.Vec2,C,J=new Float32Array(3*g),H=new Float32Array(3*g),K=[];for(C=0;C<e;C++)f=c[3*C],k=c[3*C+1],h=c[3*C+2],D.set(d[3*f],d[3*f+1],d[3*f+2]),F.set(d[3*k],d[3*k+1],d[3*k+2]),M.set(d[3*h],d[3*h+1],d[3*h+2]),y.set(b[2*f],b[2*f+1]),B.set(b[2*k],b[2*k+1]),I.set(b[2*h],b[2*h+1]),l=F.x-D.x,
n=M.x-D.x,r=F.y-D.y,m=M.y-D.y,w=F.z-D.z,u=M.z-D.z,G=B.x-y.x,z=I.x-y.x,s=B.y-y.y,v=I.y-y.y,A=1/(G*v-z*s),x.set((v*l-s*n)*A,(v*r-s*m)*A,(v*w-s*u)*A),E.set((G*n-z*l)*A,(G*m-z*r)*A,(G*u-z*w)*A),J[3*f+0]+=x.x,J[3*f+1]+=x.y,J[3*f+2]+=x.z,J[3*k+0]+=x.x,J[3*k+1]+=x.y,J[3*k+2]+=x.z,J[3*h+0]+=x.x,J[3*h+1]+=x.y,J[3*h+2]+=x.z,H[3*f+0]+=E.x,H[3*f+1]+=E.y,H[3*f+2]+=E.z,H[3*k+0]+=E.x,H[3*k+1]+=E.y,H[3*k+2]+=E.z,H[3*h+0]+=E.x,H[3*h+1]+=E.y,H[3*h+2]+=E.z;s=new pc.Vec3;v=new pc.Vec3;d=new pc.Vec3;b=new pc.Vec3;for(C=
0;C<g;C++)d.set(a[3*C],a[3*C+1],a[3*C+2]),s.set(J[3*C],J[3*C+1],J[3*C+2]),v.set(H[3*C],H[3*C+1],H[3*C+2]),c=d.dot(s),b.copy(d).scale(c),b.sub2(s,b).normalize(),K[4*C]=b.x,K[4*C+1]=b.y,K[4*C+2]=b.z,b.cross(d,s),K[4*C+3]=0>b.dot(v)?-1:1;return K};
...
pc.gfx.precalculatedTangents&&(b.tangents=pc.scene.procedural.calculateTangents(r,m,w,u));return pc.scene.procedural.createMesh(d,r,b)};
...
r.setLocalPosition(n.position[0],n.position[1],n.position[2]);r.setLocalEulerAngles(n.rotation[0],n.rotation[1],n.rotation[2]);r.setLocalScale(n.scale[0],n.scale[1],n.scale[2]);b.push(r)}for(h=1;h<k.parents.length;h++)b[k.parents[h]].addChild(b[h]);!this._device.supportsBoneTextures&&0<k.skins.length&&(h=this._device.getBoneLimit(),pc.scene.partitionSkin(k,c,h));var m=[],n=[];for(h=0;h<k.skins.length;h++){var w=k.skins[h],r=[];for(l=0;l<w.inverseBindMatrices.length;l++){var u=w.inverseBindMatrices[l];
r[l]=new pc.Mat4(u[0],u[1],u[2],u[3],u[4],u[5],u[6],u[7],u[8],u[9],u[10],u[11],u[12],u[13],u[14],u[15])}w=new pc.scene.Skin(this._device,r,w.boneNames);m.push(w);r=new pc.scene.SkinInstance(w);u=[];for(l=0;l<w.boneNames.length;l++){var G=b[0].findByName(w.boneNames[l]);u.push(G)}r.bones=u;n.push(r)}var w=[],z,r={position:pc.gfx.SEMANTIC_POSITION,normal:pc.gfx.SEMANTIC_NORMAL,tangent:pc.gfx.SEMANTIC_TANGENT,blendWeight:pc.gfx.SEMANTIC_BLENDWEIGHT,blendIndices:pc.gfx.SEMANTIC_BLENDINDICES,color:pc.gfx.SEMANTIC_COLOR,
texCoord0:pc.gfx.SEMANTIC_TEXCOORD0,texCoord1:pc.gfx.SEMANTIC_TEXCOORD1,texCoord2:pc.gfx.SEMANTIC_TEXCOORD2,texCoord3:pc.gfx.SEMANTIC_TEXCOORD3,texCoord4:pc.gfx.SEMANTIC_TEXCOORD4,texCoord5:pc.gfx.SEMANTIC_TEXCOORD5,texCoord6:pc.gfx.SEMANTIC_TEXCOORD6,texCoord7:pc.gfx.SEMANTIC_TEXCOORD7};for(h=0;h<k.vertices.length;h++){u=k.vertices[h];if(u.position&&u.normal&&u.texCoord0){G=[];for(l=0;l<k.meshes.length;l++)k.meshes[l].vertices===h&&(G=G.concat(k.meshes[l].indices));tangents=pc.scene.procedural.calculateTangents(u.position.data,
u.normal.data,u.texCoord0.data,G);u.tangent={type:"float32",components:4,data:tangents}}l=[];for(z in u){var G=u[z],s=G.type;this._device.supportsUnsignedByte||("uint8"===s&&(s="float32"),"int8"===s&&(s="float32"));l.push({semantic:r[z],components:G.components,type:a[s],normalize:!1})}l=new pc.gfx.VertexFormat(this._device,l);var s=u.position.data.length/u.position.components,v=new pc.gfx.VertexBuffer(this._device,l,s),A=new pc.gfx.VertexIterator(v);for(l=0;l<s;l++){for(z in u)switch(G=u[z],G.components){case 1:A.element[r[z]].set(G.data[l]);
break;case 2:A.element[r[z]].set(G.data[2*l],G.data[2*l+1]);break;case 3:A.element[r[z]].set(G.data[3*l],G.data[3*l+1],G.data[3*l+2]);break;case 4:A.element[r[z]].set(G.data[4*l],G.data[4*l+1],G.data[4*l+2],G.data[4*l+3])}A.next()}A.end();w.push(v)}for(h=r=0;h<k.meshes.length;h++)u=k.meshes[h],void 0!==u.indices&&(r+=u.indices.length);s=G=null;v=0;0<r&&(G=new pc.gfx.IndexBuffer(this._device,pc.gfx.INDEXFORMAT_UINT16,r),s=new Uint16Array(G.lock()));z=[];for(h=0;h<k.meshes.length;h++){u=k.meshes[h];
l=u.aabb.min;var A=u.aabb.max,A=new pc.shape.Aabb(new pc.Vec3(0.5*(A[0]+l[0]),0.5*(A[1]+l[1]),0.5*(A[2]+l[2])),new pc.Vec3(0.5*(A[0]-l[0]),0.5*(A[1]-l[1]),0.5*(A[2]-l[2]))),x=void 0!==u.indices;l=new pc.scene.Mesh;l.vertexBuffer=w[u.vertices];l.indexBuffer[0]=x?G:null;l.primitive[0].type=d[u.type];l.primitive[0].base=x?u.base+v:u.base;l.primitive[0].count=u.count;l.primitive[0].indexed=x;l.skin=void 0!==u.skin?m[u.skin]:null;l.aabb=A;x&&(s.set(u.indices,v),v+=u.indices.length);z.push(l)}0<r&&G.unlock();
w=[];u=new pc.scene.PhongMaterial;for(h=0;h<k.meshInstances.length;h++){l=k.meshInstances[h];r=b[l.node];l=z[l.mesh];(G=this._getMaterial(h,c,f))||(G=u);r=new pc.scene.MeshInstance(r,l,G);if(l.skin){l=m.indexOf(l.skin);if(-1===l)throw Error("Mesh's skin does not appear in skin array.");r.skinInstance=n[l]}w.push(r)}c=new pc.scene.Model;c.graph=b[0];c.meshInstances=w;c.skinInstances=n;c.getGraph().syncHierarchy();return c};b.prototype._getMaterial=function(a,b,c){var d;if(b&&b.length>a)if(b[a].material){if(a=
...
d._super.initializeComponentData.call(this,a,b,c)},onRemove:function(a,b){b.model&&(this.context.scene.removeModel(b.model),a.removeChild(b.model.getGraph()),b.model=null)}});return{SkyboxComponentSystem:d}}());pc.extend(pc.fw,function(){var d=function(){this.on("set",this.onSet,this)},d=pc.inherits(d,pc.fw.Component);pc.extend(d.prototype,{onSet:function(b,c,e){function d(b,c){if(!(void 0===c||null===c)){var e=a.indexOf(b),f=this.entity.skybox.assets;this.data.model=null;f[e]=this.system.context.assets.getAssetById(c);if(f[e]){if(this.data.assets=f,f[0]&&f[1]&&f[2]&&f[3]&&f[4]&&f[5]){e=this.data;a:{for(var g=this.entity,h=this.system.context,l=h.graphicsDevice,k=[],v=[],A=[],x,E=0;E<f.length;E++)if(x=f[E])if(x.resource){x=
x.resource.getSource();if(!x){logERROR(pc.string.format("Trying to load skybox component with invalid texture types"));f=void 0;break a}k.push(x)}else A.push(E),v.push(new pc.resources.TextureRequest(x.getFileUrl()));else{logERROR(pc.string.format("Trying to load skybox component before assets are loaded"));f=void 0;break a}var D=new pc.gfx.Texture(l,{format:pc.gfx.PIXELFORMAT_R8_G8_B8,cubemap:!0});D.minFilter=pc.gfx.FILTER_LINEAR_MIPMAP_LINEAR;D.magFilter=pc.gfx.FILTER_LINEAR;D.addressU=pc.gfx.ADDRESS_CLAMP_TO_EDGE;
D.addressV=pc.gfx.ADDRESS_CLAMP_TO_EDGE;v.length?(f={parent:g.getRequest()},h.loader.request(v,f).then(function(a){for(var b=0;b<a.length;b++)k[A[b]]=a[b].getSource();D.setSource(k)})):D.setSource(k);v=new pc.scene.Material;v.updateShader=function(){var a=l.getProgramLibrary().getProgram("skybox",{hdr:!1,gamma:h.scene.gammaCorrection,toneMapping:h.scene.toneMapping});this.setShader(a)};v.updateShader();v.setParameter("texture_cubeMap",D);v.cull=pc.gfx.CULLFACE_NONE;f=new pc.scene.GraphNode;g=pc.scene.procedural.createBox(l);
...
e.collision.hasEvent("collisionstart")||e.collision.hasEvent("collisionend")||e.collision.hasEvent("contact"),k=f.collision.hasEvent("collisionstart")||f.collision.hasEvent("collisionend")||f.collision.hasEvent("contact"),(v=this.hasEvent("contact"))||E||k){for(g=0;g<A;g++){var D=h.getContactPoint(g),F=this._createContactPointFromAmmo(D),M=null;if(E||k)M=this._createReverseContactPointFromAmmo(D),x.push(F),s.push(M);v&&(D=this._createSingleContactResult(e,f,F),this.fire("contact",D))}E&&(A=this._createContactResult(f,
...
h=k.mesh,l=h.indexBuffer[pc.scene.RENDERSTYLE_SOLID],n=h.vertexBuffer,r=n.getFormat(),m=r.size/4,w;for(f=0;f<r.elements.length;f++){var u=r.elements[f];u.name===pc.gfx.SEMANTIC_POSITION&&(w=new Float32Array(n.lock(),u.offset))}var l=new Uint16Array(l.lock()),n=h.primitive[0].count/3,r=new Ammo.btVector3,u=new Ammo.btVector3,G=new Ammo.btVector3,z,s,v=h.primitive[0].base,A=new Ammo.btTriangleMesh;for(f=0;f<n;f++)h=l[v+3*f]*m,z=l[v+3*f+1]*m,s=l[v+3*f+2]*m,r.setValue(w[h],w[h+1],w[h+2]),u.setValue(w[z],
w[z+1],w[z+2]),G.setValue(w[s],w[s+1],w[s+2]),A.addTriangle(r,u,G,!0);f=new Ammo.btBvhTriangleMeshShape(A,!0);m=k.node.getWorldTransform().getScale();f.setLocalScaling(new Ammo.btVector3(m.x,m.y,m.z));m=k.node.getPosition();k=k.node.getRotation();l=new Ammo.btTransform;l.setIdentity();l.getOrigin().setValue(m.x,m.y,m.z);m=new Ammo.btQuaternion;m.setValue(k.x,k.y,k.z,k.w);l.setRotation(m);d.addChildShape(l,f)}c=a.getWorldTransform().getScale();g=new Ammo.btVector3;g.setValue(c.x,c.y,c.z);d.setLocalScaling(g);
...
function(a,b,c,d,e,n,r,m,w,u,G,z,s,v,A,x,E){function D(){F.on.apply(F,arguments)}var a=a["default"],b=b["default"],c=c["default"],d=d["default"],e=e["default"],n=n["default"],r=r["default"],m=m["default"],w=w["default"],u=u["default"],F=G.config,G=G.configure,z=z["default"],s=s["default"],v=v["default"],A=A["default"];if(F.async=x["default"],"undefined"!=typeof window&&"object"==typeof window.__PROMISE_INSTRUMENTATION__){x=window.__PROMISE_INSTRUMENTATION__;G("instrument",!0);for(var M in x)x.hasOwnProperty(M)&&
D(M,x[M])}E.Promise=a;E.EventTarget=b;E.all=d;E.allSettled=e;E.race=n;E.hash=r;E.hashSettled=m;E.rethrow=w;E.defer=u;E.denodeify=c;E.configure=G;E.on=D;E.off=function(){F.off.apply(F,arguments)};E.resolve=s;E.reject=v;E.async=function(a,b){F.async(a,b)};E.map=z;E.filter=A});d.RSVP=b("rsvp")}(window);pc.promise={Promise:window.RSVP.Promise,all:window.RSVP.all};
